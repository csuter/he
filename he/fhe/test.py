from random import *
from he.fhe.public import *
from he.fhe.private import *

def test_fhe_bit_encryption_decryption():
	l = 4
	key = keygen(l,l**2,l,l**3)
	#sk = key['sk']
	#pk = key['pk']
	#num_tests = 1000
...
def test_fhe_int64_encryption_decryption():
	l = 8
	key = keygen(l,l**2)
	sk = key['sk']
	print(sk)
...
def test_fhe_int64_encrypted_single_add():
	l = 4
	key = keygen(l,l**2)
	sk = key['sk']
	pk = key['pk']
